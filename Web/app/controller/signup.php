...
VALUES (NULL, '$full_name', '$email', '$pass2', '$sex', '$contact', '$address', 1);";
    ...
    public function checkEmail($email)
    {
        ...
        if ($con->getNumRows() <= 0 && $ok == true) {
            die('<img src="http://localhost/AlgoBreizh/web/lib/tick.png"/>');
        } else {
            die('<img src="http://localhost/AlgoBreizh/web/lib/Danger_Icon.png"/>');
        }
    }
    ...
    public function passmatch()
    {
        ...
        require APP . 'view/view.signup.php';
        Util::log("Get");
        Util::setNotification("Mot de passe différent!");
