<div class="row">
    ...
    <div class="col-md-3">
        <div class="area">
            <a href="<?php Util::link('admin/addCategory'); ?>">
...
//                        echo "</div>";
                ...
                <div class="col-md-3">
                    <td>
                        <a href="<?php Util::link('admin/updateView/' . $pid); ?>">
                ...
                <div class="col-md-3">
                    <td>
                        <a href="<?php Util::link("admin/delete/" . $pid); ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="http://localhost/AlgoBreizh/web/admin/add" class="form-horizontal" method="post"
                        ...
                        <div class="from-group">
                            <button class="form-control col-md-4 btn btn-info" value="Add Product" type="submit"
                                    name="add_product">Add Product
                            </button>
                        </div>
                    </form>
                </div>
